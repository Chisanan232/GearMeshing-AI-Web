...
export function SettingsSidebar() {
  ...
  const sidebarSections: SidebarSection[] = [
    ...
    },
    {
      title: "Subscription",
      items: [
        ...(billingPlugin.PricingPlanComponent ? [{ title: "Pricing Plan", href: "/settings/subscription/pricing" }] : []),
        ...(billingPlugin.BillingTabsComponent ? [{ title: "Billing & Payment", href: "/settings/subscription/billing" }] : []),
