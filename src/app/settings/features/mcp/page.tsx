      ...
      <div className="grid gap-6">
        ...
        <Dialog open={isAdding} onOpenChange={setIsAdding}>
          <DialogTrigger asChild>
            <Button
              variant="outline"
              className="h-auto py-8 border-dashed border-neutral-800 hover:bg-neutral-900 flex flex-col gap-2"
            >
              ...
              <span className="text-xs text-neutral-500 font-normal">
                Add a local or remote MCP endpoint
              </span>
            </Button>
          </DialogTrigger>
          <DialogContent className="bg-neutral-900 border-neutral-800 text-neutral-50">
            <DialogHeader>
              ...
              <DialogDescription>
                Enter the URL of the Model Context Protocol server you wish to
                connect.
              </DialogDescription>
            </DialogHeader>
