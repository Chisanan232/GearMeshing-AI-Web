...
export default function PolicyPage() {
  ...
  const agentPolicies = policies.filter(
    (p) => p.scope === "agent" && p.agentId === selectedAgentId,
  );
    ...
    <div className="space-y-6 max-w-6xl">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-neutral-400">
          Define the boundaries and safety rules for your AI agents. Global
          policies apply to everyone, while agent-specific policies allow for
          granular control.
        </p>
      </div>
                  ...
                  <CardContent>
                    <div className="mt-4 space-y-3">
                      {policy.rules.map((rule) => (
                        <div
                          key={rule.id}
                          className="flex items-center justify-between text-sm p-2 rounded bg-neutral-950 border border-neutral-800"
                        >
        ...
        <TabsContent value="agent">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="w-full md:w-64 space-y-2">
              <h3 className="text-sm font-medium text-neutral-400 uppercase tracking-wider mb-3 px-2">
                Select Agent
              </h3>
                              ...
                              >
                                ...
                                <Badge
                                  variant={
                                    rule.action === "allow"
                                      ? "secondary"
                                      : "destructive" // Usually agent policies allow things global denies, or restrict further
                                  }
                                >
